...
// jet corrector
#include "/afs/cern.ch/user/c/cbennett/CMSSW_10_3_3_patch1/src/JetEnergyCorrections/JetUncertainty.h"
// general analysis variables
#include "/afs/cern.ch/user/c/cbennett/condorSkim/headers/AnalysisSetupV2p1.h"
// vz-fit parameters
#include "/afs/cern.ch/user/c/cbennett/condorSkim/headers/fitParameters/vzFitParams_PH.h"
...
// vz-fit function
#include "/afs/cern.ch/user/c/cbennett/condorSkim/headers/fitFunctions/fitFxn_vz_PH.h"
// hiBin-fit function
...
// print introduction
#include "/afs/cern.ch/user/c/cbennett/condorSkim/headers/introductions/printIntroduction_PYTHIAHYDJET_scan_V3p7.h"
// analysis config
...
void PYTHIAHYDJET_scan_V3p7_JEU(TString input = "/eos/user/c/cbennett/forests/PYTHIAHYDJET_DiJet_5July22/DiJet_pThat-15_TuneCP5_HydjetDrumMB_5p02TeV_Pythia8/crab_PYTHIAHYDJET_DiJet_5July22/220705_212159/0000/HiForestAOD_104.root", TString output = "out.root"){

  // version notes:
  // 3.5: - adding jet pt, jet phi, jet eta maps to look for hot spots.
  // 3.6: - adding weight = (prescale) (even though redundant with prescale = 1, should do this anyway)
  //      - Adding eta/phi mask around phi = (0.4,0.8) && eta = (-0.3,1.4)
  // 3.7: - only a name change.  Canceling couts.
  ...
  JetUncertainty JEU("/afs/cern.ch/user/c/cbennett/CMSSW_10_3_3_patch1/src/JetEnergyCorrections/Autumn18_HI_V8_MC_Uncertainty_AK4PF.txt");
  ...
  for(int evi = 0; evi < NEvents; evi++){
    ...
    for(int i = 0; i < em->njet ; i++){
      ...
      //cout << "rawPt = " << em->rawpt[i] << " | corrPt = " << x << endl;
      JEU.SetJetPT(x);
      JEU.SetJetEta(y);
      JEU.SetJetPhi(z);
      ...
      cout << " corrPt = " << x << " | corrPt_down = " << correctedPt_down << " | corrPt_up = " << correctedPt_up << endl;
