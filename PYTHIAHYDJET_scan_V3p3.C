...
// vz-fit parameters
#include "/afs/cern.ch/user/c/cbennett/condorSkim/headers/fitParameters/vzFitParams_PH_C0.h"
...
// vz-fit function
#include "/afs/cern.ch/user/c/cbennett/condorSkim/headers/fitFunctions/fitFxn_vz.h"
// hiBin-fit function
...
// print introduction
#include "/afs/cern.ch/user/c/cbennett/condorSkim/headers/introductions/printIntroduction_PYTHIAHYDJET_scan_V3p3.h"
// analysis config
#include "/afs/cern.ch/user/c/cbennett/condorSkim/headers/config/config_PYTHIAHYDJET.h"
// read config
...
// ------------------------------------- analysis histograms ------------------
TH2D *h_recoGenDr_flavor[NCentralityIndices];
TH2D *h_recoGenDpt_flavor[NCentralityIndices];
...
void PYTHIAHYDJET_scan_V3p3(TString input = "root://cmsxrootd.fnal.gov//store/user/cbennett/PYTHIAHYDJET_DiJet_5July22/DiJet_pThat-15_TuneCP5_HydjetDrumMB_5p02TeV_Pythia8/crab_PYTHIAHYDJET_DiJet_5July22/220705_212159/0000/HiForestAOD_104.root", TString output = "out.root"){

// JET ENERGY CORRECTIONS
vector<string> Files;
//Files.push_back("/home/clayton/Analysis/code/JetEnergyCorrections/Autumn18_HI_V6_MC_L2Relative_AK4PF.txt"); // LOCAL
...
JetCorrector JEC(Files);
  ...
  printIntroduction_PYTHIAHYDJET_scan_V3p3();
  readConfig();
  
  // define histograms
  // >> NEvents
  h_NEvents = new TH1D("h_NEvents","Number of events (L3Mu5 trigger)",1000,0,1000);
  // >> hiBin
  ...
  for(int i = 0; i < NCentralityIndices; i++){
    ...
    if(i==0){
      // ----------------------------------------- event histograms -----------------
      // >> vz
      h_vz[i] = new TH1D(Form("h_vz_C%i",i),Form("vz, events with inclRecoJet, hiBin %i - %i",centEdges[0],centEdges[NCentralityIndices-1]),100,-15,15);
      h_vz_inclGenMuonTag[i] = new TH1D(Form("h_vz_inclGenMuonTag_C%i",i),Form("vz, events with inclRecoJet-inclGenMuonTag, hiBin %i - %i",centEdges[0],centEdges[NCentralityIndices-1]),100,-15,15);
      h_vz_inclRecoMuonTag[i] = new TH1D(Form("h_vz_inclRecoMuonTag_C%i",i),Form("vz, events with inclRecoJet-inclRecoMuonTag, hiBin %i - %i",centEdges[0],centEdges[NCentralityIndices-1]),100,-15,15);
      h_vz_matchedRecoMuonTag[i] = new TH1D(Form("h_vz_matchedRecoMuonTag_C%i",i),Form("vz, events with inclRecoJet-matchedRecoMuonTag, hiBin %i - %i",centEdges[0],centEdges[NCentralityIndices-1]),100,-15,15);
      h_vz_inclRecoMuonTag_triggerOn[i] = new TH1D(Form("h_vz_inclRecoMuonTag_triggerOn_C%i",i),Form("vz, events with inclRecoJet-inclRecoMuonTag-triggerOn, hiBin %i - %i",centEdges[0],centEdges[NCentralityIndices-1]),100,-15,15);
      h_vz_matchedRecoMuonTag_triggerOn[i] = new TH1D(Form("h_vz_matchedRecoMuonTag_triggerOn_C%i",i),Form("vz, events with inclRecoJet-matchedRecoMuonTag-triggerOn, hiBin %i - %i",centEdges[0],centEdges[NCentralityIndices-1]),100,-15,15);
      // ------------------------------- incl. reco jets per flavor -----------------
      ...
      // ------------------------------------- analysis histograms ------------------
      h_recoGenDr_flavor[i] = new TH2D(Form("h_recoGenDr_C%i",i),Form("JetFlavorID vs #Delta r(recoJet,genJet), hiBin %i - hiBin %i",centEdges[0],centEdges[NCentralityIndices-1]),100,0,1,27,-5,22); 
      h_recoGenDpt_flavor[i] = new TH2D(Form("h_recoGenDpt_C%i",i),Form("JetFlavorID vs #Delta p_{T}/p_{T}(recoJet,genJet), hiBin %i - hiBin %i",centEdges[0],centEdges[NCentralityIndices-1]),100,0,5,27,-5,22); 
      ...
      // ----------------------------------------- event histograms -----------------
      h_vz[i] = new TH1D(Form("h_vz_C%i",i),Form("vz, events with inclRecoJet, hiBin %i - %i",centEdges[i-1],centEdges[i]),100,-15,15);
      h_vz_inclGenMuonTag[i] = new TH1D(Form("h_vz_inclGenMuonTag_C%i",i),Form("vz, events with inclRecoJet-inclGenMuonTag, hiBin %i - %i",centEdges[i-1],centEdges[i]),100,-15,15);
      h_vz_inclRecoMuonTag[i] = new TH1D(Form("h_vz_inclRecoMuonTag_C%i",i),Form("vz, events with inclRecoJet-inclRecoMuonTag, hiBin %i - %i",centEdges[i-1],centEdges[i]),100,-15,15);
      h_vz_matchedRecoMuonTag[i] = new TH1D(Form("h_vz_matchedRecoMuonTag_C%i",i),Form("vz, events with inclRecoJet-matchedRecoMuonTag, hiBin %i - %i",centEdges[i-1],centEdges[i]),100,-15,15);
      h_vz_inclRecoMuonTag_triggerOn[i] = new TH1D(Form("h_vz_inclRecoMuonTag_triggerOn_C%i",i),Form("vz, events with inclRecoJet-inclRecoMuonTag-triggerOn, hiBin %i - %i",centEdges[i-1],centEdges[i]),100,-15,15);
      h_vz_matchedRecoMuonTag_triggerOn[i] = new TH1D(Form("h_vz_matchedRecoMuonTag_triggerOn_C%i",i),Form("vz, events with inclRecoJet-matchedRecoMuonTag-triggerOn, hiBin %i - %i",centEdges[i-1],centEdges[i]),100,-15,15);
      // ------------------------------- incl. reco jets per flavor -----------------
      ...
      // ------------------------------------- analysis histograms ------------------
      h_recoGenDr_flavor[i] = new TH2D(Form("h_recoGenDr_C%i",i),Form("JetFlavorID vs #Delta r(recoJet,genJet), hiBin %i - hiBin %i",centEdges[i-1],centEdges[i]),100,0,1,27,-5,22); 
      h_recoGenDpt_flavor[i] = new TH2D(Form("h_recoGenDpt_C%i",i),Form("JetFlavorID vs #Delta p_{T}/p_{T}(recoJet,genJet), hiBin %i - hiBin %i",centEdges[i-1],centEdges[i]),100,0,5,27,-5,22); 
    ...
    h_recoGenDr_flavor[i]->Sumw2();
    h_recoGenDpt_flavor[i]->Sumw2();
  ...
  for(int i = 0; i < NCentralityIndices; i++){
    ...
    h_recoGenDr_flavor[i]->Write();
    h_recoGenDpt_flavor[i]->Write();
